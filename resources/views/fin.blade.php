...
<section class="rsvp-fin">
	...
	<h2>Hi {{ Auth::user()->name }}! @if(Auth::user()->u_group == 1)<a href="{{ route("admin.cp") }}">go to admin view.</a> @endif</h2>
	...
	<form action="{{ route("rsvp.update") }}" method="POST" class="form rsvp-update">
		...
		<div class="cal">
			<p>
				{{-- <strong><img src="{{ asset("imgs/icons/cal.png") }}" alt="calendar icon">Add to:</strong><br> --}}
				...
				<em><img src="{{ asset("imgs/icons/cal.png") }}" alt="calendar icon">Add to Calendar</em></a>
				<br>
				{{-- <a target="_blank" href="https://calendar.google.com/calendar/ical/3t54i03kcmm0md1tic5cec7vdk%40group.calendar.google.com/public/basic.ics">
				<em>iCloud Calendar</em></a> --}}
			</p>
		</div>
		@endif
	</form>
